...
08282016 Added ACl builder and bulk load ACL. Inventory report
...
def login():
    ...
    if request.method == 'POST':
        ...
        ipaddress = 'https://'+request.form.get('ipaddress')+':8443'
        # Configuring a connection to the VSD API
        nc = vsdk.NUVSDSession(username=userx, password=passwd, enterprise=org, api_url=ipaddress)
...
def testx():
    nuage_user = logx()
    return render_template('test.html', nuage_user = nuage_user)
