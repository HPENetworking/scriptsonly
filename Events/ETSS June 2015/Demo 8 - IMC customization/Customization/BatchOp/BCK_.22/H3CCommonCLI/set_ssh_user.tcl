...
if { $my_authentication == "password" } {
...
} elseif { $SSHUserPublicKeyName == "" || $SSHUserWorkDirectory == "" } {
    send "ssh user $SSHUserName service-type $my_servicetype authentication-type $my_authentication\r"
} elseif { $SSHUserServiceType == 3 } {
    ...
    send "ssh user $SSHUserName service-type $my_servicetype authentication-type $my_authentication assign publickey $SSHUserPublicKeyName work-directory $SSHUserWorkDirectory\r"
}
sleep 1
expect {
