...
def update_DB_Yammer(email):
	...
	auth_token="Replace_with_your_YammerToken"
	...
	mariadb_connection = mariadb.connect(user='your_DB_User', password='Your_DB_Password', database='Users')
...
def main():
	...
	token_script="Put_A_Token_To_Secure_The_Script_Usage"
	updateResult = ""
